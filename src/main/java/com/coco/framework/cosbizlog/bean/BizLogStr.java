...
import com.coco.framework.cosbizlog.annotation.BizLogVsClass;
import com.coco.framework.cosbizlog.annotation.BizLogVsField;
import com.coco.framework.cosbizlog.util.CosBizLogConstant;
import com.coco.framework.cosbizlog.util.WrappedBeanCopier;
...
public abstract class BizLogStr {
    ...
    public String prefixBizLogStr() {
        return getId() != null ? "id: " + getId().toString() + CosBizLogConstant.MARK_NEW_LINE : "";
    }
